...
public class UpdateManager
{
	...
	private int getVersionCode(Context context)
	{
		...
		try
		{
			...
			versionCode = context.getPackageManager().getPackageInfo("com.csw.tianlai_ui", 0).versionCode;
	...
	private void showDownloadDialog()
	{
		...
		builder.setView(v);
		// 取消更新
		builder.setNegativeButton(R.string.soft_update_true, new OnClickListener()
		{
			public void onClick(DialogInterface dialog, int which)
			{
				dialog.dismiss();
